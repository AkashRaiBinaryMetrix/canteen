...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('public/admin/vendor/images/bg-01.jpg');">
			...
			@endif
				<form class="login100-form validate-form" method="post" action="{{url('admin/change-password/'.$id)}}" id="changepform">
					...
					<div class="wrap-input100 validate-input m-b-23">
						...
						<input class="input100" type="password" name="password" placeholder="Type your password" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');" id="passwordc">
					...
					<div class="wrap-input100 validate-input m-b-23">
						...
						<input class="input100" type="password" name="confirm_password" placeholder="Type your confirm password" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');" id="passwordcp">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
					<span id="cperr"></span>
					<span id="passcperr"></span>
					
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<button class="login100-form-btn" type="button" id="changebtn">
								Submit
							</button>
						</div>
					</div>
